...
In a recent article, Mostad et al.~\cite{mostad} present a probabilistic approach to handle missing data (no-calls) in low-coverage sequencing, where they integrate genotype likelihoods directly into computations on familial relationships.
