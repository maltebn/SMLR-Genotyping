...
An alternative approach to handling uncertainty in low-coverage data is the probabilistic model described by Mostad et al. (\citeyear{mostad})~\cite{mostad}, which derives genotype likelihoods $P(s \mid G)$ and combines them with prior genotype probabilities $P(G)$ to compute $P(G \mid s)$ via Bayes’ theorem.
