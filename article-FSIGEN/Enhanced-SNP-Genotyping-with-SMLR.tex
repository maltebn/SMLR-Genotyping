...
Table~\ref{tab:NC_WC} also shows that the accuracy of the SMLR model is comparable to that of the MTK model, with a slight advantage for SMLR across all DNA amounts, and furthermore that the SMLR model has a call rate advantage, particularly at 62.5 and 50 pg DNA.
\subfile{table1.tex}
...
Table~\ref{tab:NC_WC} shows that the SMLR and MTK models have comparable accuracies and call rates across all examined DNA quantities, with SMLR generally surpassing MTK, especially at 50 and 62.5 pg DNA, where its call rate is 9\% and 12\% higher.
