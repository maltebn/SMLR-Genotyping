...
```{r}
# (het_props <- dd_GT |> filter(Dilution == 1000) |>
#   group_by(ID) |>
#   summarise("Proportion a1a1" = sum(Genotype_true_AA == "A1A1")/n(),
#             "Proportion a2a2" = sum(Genotype_true_AA == "A2A2")/n(),
#             "Proportion a1a2" = sum(Genotype_true_AA == "A1A2")/n()))

# (het_props_2nd <- true_profiles_2nd |> group_by(ID) |>
#   summarise("Proportion a1a1" = sum(Genotype_true_AA == "A1A1")/n(),
#             "Proportion a2a2" = sum(Genotype_true_AA == "A2A2")/n(),
#             "Proportion a1a2" = sum(Genotype_true_AA == "A1A2")/n()))

# het_props <- c(het_props$`Proportion a1a2`, het_props_2nd$`Proportion a1a2`)
# eb <- EnvStats::ebeta(het_props)
