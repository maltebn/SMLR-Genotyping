...
ggsave(filename = file.path("..", "article-FSIGEN", "FIG_2-two-column.bmp"),
       plot = p, device = "bmp", width = 200.15, height = 99.99, units = "mm", dpi = 1000)
knitr::plot_crop(file.path("..", "article-FSIGEN", "FIG_2-two-column.bmp"))
```
...
(p <- ph + pr + pm + 
   ...
   theme(legend.spacing.y = unit(0, 'mm'),
         legend.margin = margin(t=1.67, r=0, b=1.67, l=2, unit = 'mm'),
         legend.key.spacing = unit(1, 'mm'),
         legend.key.height = unit(4, 'mm')))

ggsave(filename = file.path("..", "article-FSIGEN", "FIG_1-two-column.bmp"),
       plot = p, device = "bmp", width = 198.19, height = 69.9, units = "mm", dpi = 1000)
knitr::plot_crop(file.path("..", "article-FSIGEN", "FIG_1-two-column.bmp"))
```
