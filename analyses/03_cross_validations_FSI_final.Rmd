...
ggsave(filename = file.path("..", "article-FSIGEN", "FIG_S2-two-column.bmp"),
       plot = p, device = "bmp", width = 199.76, height = 99.93, units = "mm", dpi = 1000)
knitr::plot_crop(file.path("..", "article-FSIGEN", "FIG_S2-two-column.bmp"))
```
