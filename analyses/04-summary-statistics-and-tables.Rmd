...
dd_mostad <- readRDS(file.path("..", "data", "00_dd_mostad.rds"))
```
...
dd_pred <- predict_prob_threshold(dd_mostad, m_fit) |> 
...
p <- p_s + p_no + plot_layout(ncol = 2, nrow = 1, guides = "collect") & theme_bw()
...
ff <- c("NI", "", "log_NI", "log_", "I_NI", "I_")
datafile_name <- paste0("00_obj_crossval_C_", ff, "1K_9pers_",
...
names(NC_diff_smlr_hsg) <- gsub("1K_9pers|\\.rds", "", str_sub(datafile_name, 19))
